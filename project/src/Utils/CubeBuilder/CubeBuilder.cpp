...
static const float CubeBuilderSize = 1;

shared_ptr<Object> CubeBuilder::makeCube(float x, float y, float z, int red, int green, int blue) {
    ...
    putCeilAtXYZ(0, 0, 0);
    putLeftWallAtXYZ(0, 0, 0);
    putRightWallAtXYZ(0, 0, 0);
    putBackWallAtXYZ(0, 0, 0);
    putFrontWallAtXYZ(0, 0, 0);
    putFloorAtXYZ(0, 0, 0);
